...
import torch
from nnunet.network_architecture.generic_UNet_AL import Generic_UNet_AL
...
class Generic_UNet_AL_DP(Generic_UNet_AL):
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        """
        super(Generic_UNet_AL_DP, self).__init__(input_channels, base_num_features, num_classes, num_pool,
                                              num_conv_per_stage,
    ...
    def forward(self, x, y=None, return_hard_tp_fp_fn=False):
        res = super(Generic_UNet_AL_DP, self).forward(x)  # regular Generic_UNet forward pass
